...
namespace MVCFinalProject.Controllers
{
    ...
    {
        private readonly DbvehiclesContext _context;

        public VehiclesController(DbvehiclesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbvehiclesContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
